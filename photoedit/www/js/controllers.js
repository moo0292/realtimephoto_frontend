...
.controller('PhotoEditCtrl', function($scope){
	...
	angular.element(document).ready(function () {
		...
		var brightFilterDecrease = new fabric.Image.filters.Brightness({brightness: $scope.decreaseBrightness})
		...
		$scope.changeBW = function() {
			!$scope.isBlackAndWhite;
			// if ($scope.isBlackAndWhite == true) {
			// 	$scope.isBlackAndWhite = false;
			// 	console.log("test");
			// } else if ($scope.isBlackAndWhite == false) {
			// 	$scope.isBlackAndWhite = true;
			// }
		}
